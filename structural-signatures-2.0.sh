...
$homed/bin/scripts/get_struct_from_db.pl $homed/database/structure_database.db $type $name $homed/bin/files/parentchild.txt $input $output $homed/bin/files/available_uniprot_ids.csv yes 2> /dev/null
